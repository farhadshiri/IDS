...
int IdsEvaluator::EvaluateTestIds(char *EvaluationResultsStr)
{
    ...
    printf ("=============================================\n");
    printf ("Results of LogCorrelation system evaluation:\n%s\n", EvaluationResultsStr);
    printf ("=============================================\n");
