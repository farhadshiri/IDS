#############################################################################
# Makefile for building: LogCorrelation
# Generated by qmake (1.04a) (Qt 3.1.1) on: Sun Aug 24 06:48:33 2018
# Project:  LogCorrelation.pro
# Template: app
# Command: $(QMAKE) -o Makefile LogCorrelation.pro
#############################################################################
...
LEX      = flex
YACC     = yacc
CFLAGS   = -pipe -Wall -W -O2 -march=i386 -mcpu=i686 -g -DGLX_GLXEXT_LEGACY -fno-use-cxa-atexit -fno-exceptions  -DQT_THREAD_SUPPORT -DQT_NO_DEBUG
CXXFLAGS = -pipe -Wall -W -O2 -march=i386 -mcpu=i686 -g -DGLX_GLXEXT_LEGACY -fno-use-cxa-atexit -fno-exceptions  -DQT_THREAD_SUPPORT -DQT_NO_DEBUG
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I$(QTDIR)/mkspecs/default -I. -I$(QTDIR)/include -I.ui/ -I.moc/
LINK     = g++
LFLAGS   = 
LIBS     = $(SUBLIBS) -L$(QTDIR)/lib -L/usr/X11R6/lib /usr/lib/libpcap.so -lqt-mt -lXext -lX11 -lm
AR       = ar cqs
RANLIB   = 
MOC      = $(QTDIR)/bin/moc
UIC      = $(QTDIR)/bin/uic
...
DIST	   = LogCorrelation.pro
QMAKE_TARGET = LogCorrelation
DESTDIR  = 
...
Makefile: LogCorrelation.pro  $(QTDIR)/mkspecs/default/qmake.conf 
	$(QMAKE) -o Makefile LogCorrelation.pro
qmake: 
	@$(QMAKE) -o Makefile LogCorrelation.pro

dist: 
	@mkdir -p .obj/LogCorrelation && $(COPY_FILE) --parents $(SOURCES) $(HEADERS) $(FORMS) $(DIST) .obj/LogCorrelation/ && $(COPY_FILE) --parents frmPreProcessorSetting.ui.h frmNeuralNetSetting.ui.h frmMain.ui.h frmDataProvidersSetting.ui.h frmProgressWindow.ui.h frmIdsEvaluator.ui.h frmResponderSetting.ui.h frmCapturePacketsSetting.ui.h .obj/LogCorrelation/ && ( cd `dirname .obj/LogCorrelation` && $(TAR) LogCorrelation.tar LogCorrelation && $(GZIP) LogCorrelation.tar ) && $(MOVE) `dirname .obj/LogCorrelation`/LogCorrelation.tar.gz . && $(DEL_FILE) -r .obj/LogCorrelation
...
.ui/qmake_image_collection.cpp: images/Contents.png \
	...
	$(UIC)  -embed LogCorrelation images/Contents.png images/DataProviderSetting.png images/EvaluateNet.png images/Exit.png images/FileNew.png images/FileOpen.png images/FileSaveAs.png images/Help.png images/NeuralNetSetting.png images/PreProcessorSetting.png images/Print.png images/ResponderSetting.png images/StartOffLine.png images/StartOnLine.png images/StopOnLine.png images/TestNet.png images/TrainNet.png images/UNNID.png images/FileSave.png images/FileOpen_Small.png -o .ui/qmake_image_collection.cpp
